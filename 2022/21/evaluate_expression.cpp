    ...
    for (size_t i = 0; i < expression.length(); ++i) {
        if (isdigit(expression[i])) {
            ...
            while (!operatorStack.empty() && operatorStack.top() != '(') {
                long long num2 = operandStack.top();
                operandStack.pop();
                long long num1 = operandStack.top();
                operandStack.pop();
            ...
            while (!operatorStack.empty() && operatorStack.top() != '(' && priority(operatorStack.top()) >= priority(expression[i])) {
                long long num2 = operandStack.top();
                operandStack.pop();
                long long num1 = operandStack.top();
                operandStack.pop();
